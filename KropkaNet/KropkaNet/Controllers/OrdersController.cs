...
namespace KropkaNet.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var stocktakingContext = _context.Orders.Include(o => o.Department);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var order = await _context.Orders
                .Include(o => o.Department).ThenInclude(d => d.Company)
        ...
        public async Task<IActionResult> Create([Bind("Id,DateOfOrderExecution,State,DepartmentId,StocktakingId")] CreateOrderDto createOrderDto)
        {
            var order = _mapper.Map<Order>(createOrderDto);
            order.State = 0;
            order.Stocktaking = null;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateOfOrderExecution,State,DepartmentId,StocktakingId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
